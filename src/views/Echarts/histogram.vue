<template>
  <div class="histogram">
    ...
    <el-row>
      <el-col :span="10"
        ><div class="grid-content bg-purple">
          <div class="echarts-histogram1" id="echarts-histogram1"></div></div
      ></el-col>
    </el-row>
  </div>
</template>
...
export default {
  ...
  methods: {
    histogram() {
      var chartDom = document.getElementById("echarts-histogram");
    ...
    histogram1() {
      var chartDom = document.getElementById("echarts-histogram1");
      var myChart = echarts.init(chartDom);
      var option;
